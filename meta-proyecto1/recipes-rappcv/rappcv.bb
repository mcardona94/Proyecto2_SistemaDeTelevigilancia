...
SRC_URI = "file://appcv.py \
           file://Beatles.png \
           file://Peoplewalking.mov \
          " 
...
do_install () {
        install -d ${D}${bindir}
        install -m 0755 appcv.py ${D}${bindir}
        install -m 0644 Beatles.png ${D}${bindir}
        install -m 0644 Peoplewalking.mov ${D}${bindir}
}
